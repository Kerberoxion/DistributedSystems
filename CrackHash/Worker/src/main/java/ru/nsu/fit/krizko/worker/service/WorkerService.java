...
import ru.nsu.fit.krizko.worker.ManagerClient;
...
public class WorkerService{
    ...
    public WorkerService(ManagerClient managerClient){this.managerClient = managerClient;}
    ...
    public void sendResult(UUID requestId, List<String> words){
        managerClient.sendResult(requestId, words);
    }
}
